...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        writeBlockSize->setMinimum(512);
        writeBlockSize->setMaximum(8192);
        writeBlockSize->setSingleStep(512);
        ...
        readBlockSize->setObjectName("readBlockSize");
        readBlockSize->setMinimum(512);
        readBlockSize->setMaximum(8192);
        readBlockSize->setSingleStep(512);
        ...
        menubar->setGeometry(QRect(0, 0, 284, 23));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        writeBlockSize->setSuffix(QCoreApplication::translate("MainWindow", " bytes", nullptr));
        label_5->setText(QCoreApplication::translate("MainWindow", "Write block size", nullptr));
        readBlockSize->setSuffix(QCoreApplication::translate("MainWindow", " bytes", nullptr));
